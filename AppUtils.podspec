Pod::Spec.new do |s|
    ...
    DESC
    s.homepage     = "https://github.com/softwaredavid/AppUtils.git"
    s.license      = "MIT"
    s.license      = { :type => "MIT", :file => "LICENSE" }
    s.author             = { "softwaredavid" => "softwaredavid@gmail.com" }
    s.platform     = :ios,"8.0" 
    s.source       = { :git => "https://github.com/softwaredavid/AppUtils.git", :tag => "0.0.1" }
    s.source_files  = "AppUtils/AppUtils/Utils/**/*.{h,m,swift}"
